...
const navigation = {
    ...
    Authors: [
      { name: 'Author Benefits', href: '#' },
      { name: 'Article Processing Charges', href: '#' },
      { name: 'News and Alerts', href: '#' },
      { name: 'Insights', href: '#' },
    ],
    support: [
      { name: 'Pricing', href: '#' },
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold leading-6 text-white">Authors</h3>
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.Authors.map((item) => (
                      <li key={item.name}>
